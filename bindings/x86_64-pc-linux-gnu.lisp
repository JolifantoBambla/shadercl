...
(cffi:defcenum (%glslang::optimization-level-t
                :unsigned-int)
...
(cffi:defcenum (%glslang::target-client-version-t
                :unsigned-int)
...
(cffi:defctype %glslang::target-client-version-t
               %glslang::target-client-version-t)
...
(eval-when (:load-toplevel :compile-toplevel :execute)
  ...
  (export '%glslang::source-t :%glslang)
  (export '%glslang::target-client-version-t
          :%glslang)
